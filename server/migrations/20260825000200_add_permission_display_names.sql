...
FROM (
    VALUES
        ...
        ('hr.departments.read', 'Xem phòng ban', 'Xem danh sách phòng ban trong doanh nghiệp.'),
        ('hr.departments.manage', 'Quản lý phòng ban', 'Tạo và cập nhật phòng ban.'),
        ('hr.jobs.read', 'Xem vị trí công việc', 'Xem danh sách vị trí và loại công việc.'),
        ('hr.jobs.manage', 'Quản lý vị trí công việc', 'Tạo và cập nhật vị trí và loại công việc.'),
        ('hr.assignments.read', 'Xem phân công tổ chức', 'Xem lịch sử phân công tổ chức của nhân viên.'),
        ('hr.assignments.manage', 'Quản lý phân công tổ chức', 'Tạo và cập nhật phân công tổ chức có thời hạn cho nhân viên.'),
        ('hr.working_schedules.read', 'Xem lịch làm việc', 'Xem lịch làm việc và nhân viên được áp dụng lịch.'),
        ('hr.working_schedules.self.read', 'Xem lịch làm việc của tôi', 'Xem lịch làm việc được áp dụng cho nhân viên hiện tại.'),
        ('hr.working_schedules.manage', 'Quản lý lịch làm việc', 'Tạo, cập nhật lịch làm việc và phân công lịch cho nhân viên.'),
        ...
        ('payroll.config.read', 'Xem cấu hình lương', 'Xem quy tắc mức lương và cấu hình tính lương.'),
        ('payroll.config.manage', 'Quản lý cấu hình lương', 'Tạo và cập nhật quy tắc mức lương.'),
        ('payroll.runs.read', 'Xem kỳ tính lương', 'Xem các kỳ tính lương và kết quả của nhân viên.'),
        ('payroll.runs.manage', 'Tính lương', 'Tạo và tính toán kỳ lương hàng tháng.'),
        ('payroll.runs.approve', 'Duyệt kỳ lương', 'Duyệt kết quả của kỳ tính lương.'),
